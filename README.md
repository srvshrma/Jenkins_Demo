springmvc-jenkins: Kitchensink Example using Spring 4.x
==============================================================
Author: Marius Bogoevici, Tejas Mehta, Joshua Wilson  
Level: Intermediate  
Technologies: JSP, JPA, JSON, Spring, JUnit  
Summary: The `springmvc-jenkins` quickstart is an example of a Java EE 6 application using JSP, JPA 2.0 and Spring 4.x.  
Target Product: WFK  
...
The `springmvc-jenkins` quickstart is an example of a Java EE 6 application using JSP, JPA 2.0 and Spring 4.x. It 
...
* In `jboss-as-spring-mvc-context.xml` `<context:component-scan base-package="com.example.jenkins.controller"/>` 
...
4. This will deploy `target/springmvc-jenkins.war` to the running instance of the server.


Access the application
----------------------

The application will be running at the following URL: <http://localhost:8080/springmvc-jenkins/>.
